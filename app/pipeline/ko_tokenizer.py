...
FAQ_STOPWORDS: frozenset[str] = frozenset({
    # 어미·의문사 잔여 (strip_suffix가 완벽하지 않을 때 대비)
    "하나요", "있나요", "되나요", "알려", "알려줘", "알려주세요",
    "해야", "인지", "인가", "는가",
    "뭐야", "뭐", "뭘", "뭔가", "뭐가", "뭔지",
    # 메타 단어 (질문/답변 그 자체를 지칭)
    "질문", "답변", "문의", "안내",
    # 장소·의문사 — FAQ 토픽 매칭에 절대 영향 없는 안전한 stopword만
    # (2026-04-16) 위험 단어(오늘/내일/이번/다음 등)는 학사일정 구분에 필요 → 제외
    "교내", "학교", "캠퍼스", "우리",
    "어디", "어떻게", "무엇", "언제", "얼마",
    # 식사 시간대 — 학사 도메인에선 의미 구분 기여 없음 (식당 FAQ 한정)
    # 현 FAQ 코퍼스에서 영향 0건 검증 완료 (2026-04-16).
    # 식사 관련 FAQ 추가 시 재평가 필요.
    "점심", "저녁", "아침", "식사",
})
